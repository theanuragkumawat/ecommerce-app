...
function Footer() {
    ...
    let year = new Date().toLocaleDateString('in', { year: "numeric" })
        ...
        <footer className="bg-white dark:bg-gray-900">
            <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                <div className="lg:flex lg:items-start lg:gap-8">
                    ...
                    <div className="mt-1 sm:mt-3 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                        ...
                        <div className="col-span-2 sm:col-span-1">
                            ...
                            <ul className="mt-6 space-y-4 text-sm">
                                <li>
                                    <span className="text-gray-700 transition hover:opacity-75 dark:text-gray-200">
                                        1on1 Coaching
                                    </span>
                                </li>
                ...
                <div className="pt-8 dark:border-gray-800">
                    <div className="sm:flex sm:justify-between">
                        ...
                        <ul className="mt-8 flex flex-wrap justify-start gap-4 text-xs sm:mt-0 lg:justify-end">
                            <li>
                                <span className="text-gray-500 transition hover:opacity-75 dark:text-gray-400">
                                    Terms & Conditions
                                </span>
                            </li>
